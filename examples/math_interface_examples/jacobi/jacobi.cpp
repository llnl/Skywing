...
/* This main function is for running locally, not on LC. To do so,
   either use the run.sh script or start each agent yourself by running

    ./jacobi config.cfg <agent index>
*/
