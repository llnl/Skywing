...
The naming convention used in the example for data input for each Skynet agent can be obtained by observing sync_jacobi.cpp, and the accompanying python preprocessing script named jacobi_pre_processing.py.
