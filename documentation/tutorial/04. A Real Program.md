...
The only significant piece missing is a `main` function to configure the
initial agent connection, submit the Jobs to a Skywing manager and
start it all up. A Job function, as
