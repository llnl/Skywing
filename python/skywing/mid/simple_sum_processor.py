...
class SimpleSumProcessor(Processor):
    ...
    # DEPRECATED: However, since its still an abstractmethod of the parent class, we have to define it.
    # Remove once the convert is fully deprecated
    def convert(self, publish_data):
        pass

    # DEPRECATED: However, since its still an abstractmethod of the parent class, we have to define it
    # Remove once the deconvert is fully deprecated
