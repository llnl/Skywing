...
public:
  MasterReduceGroupIsCreated(Master& master, const TagID& group_id) noexcept;
  bool operator()() const noexcept;
...
public:
  MasterConnectionIsComplete(Master& master, const std::string& address, std::uint16_t port) noexcept;
  bool operator()() const noexcept;
...
public:
  MasterGetConnectionSuccess(Master& master, const std::string& address, std::uint16_t port) noexcept;
  bool operator()() const noexcept;
