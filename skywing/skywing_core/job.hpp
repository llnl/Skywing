...
public:
  ...
  void publish(const skywing_core::Tag<PublishTagTypes...>& tag, ArgTypes&&... values) noexcept
  {
    static_assert(
  ...
  void publish(const skywing_core::Tag<PublishTagTypes...>& tag, const std::tuple<TupleTypes...>& value_tuple) noexcept
  {
